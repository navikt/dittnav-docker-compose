...
object DockerComposeDefaults {
    ...
    val commonEnvironment : Map<String, String> = mapOf(
            ...
            "AZURE_OPENID_CONFIG_ISSUER" to "http://auth-mock.dittnav.docker-internal:8080",
            "AZURE_OPENID_CONFIG_TOKEN_ENDPOINT" to "http://auth-mock.dittnav.docker-internal:8080/azure/token",
            "AZURE_APP_WELL_KNOWN_URL" to "http://auth-mock.dittnav.docker-internal:8080/azure/.well-known/oauth-authorization-server",
            ...
            "TOKEN_X_WELL_KNOWN_URL" to "http://auth-mock.dittnav.docker-internal:8080/tokendings/.well-known/oauth-authorization-server",
            "TOKEN_X_WELL_KNOWN_URL" to "http://auth-mock.dittnav.docker-internal:8080/tokendings/.well-known/oauth-authorization-server"
    )
